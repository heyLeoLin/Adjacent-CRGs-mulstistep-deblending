'''
Author: Lin Shicong
Task: PDB Data Deblending (3CRG) - Step 3
Description: 
- Architecture: lightweight U-Net (Dropout 0.5)
- Optimizer: AdamW with Warmup Cosine Annealing Learning Rate
- Stage: Step 3 (Transfer Learning) Takes previous predictions as input to further refine the results.
'''
...
epochs = 50  
batch_size = 2
initial_lr = 5e-4    # Lower learning rate for fine-tuning

# Setup directories
load_dir = '../result/3c1_step2'  # Directory containing previous step's output and model
save_dir = '../result/3c1_step3'  # Directory for saving current step's results
